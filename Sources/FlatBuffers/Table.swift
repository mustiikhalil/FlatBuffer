...
extension Table {
    ...
    static public func indirect(_ o: Int32, _ fbb: FlatBuffer) -> Int32 { return o + fbb.read(def: Int32.self, position: Int(o)) }
    ...
    static public func compare(_ off1: Int32, _ key: [Byte], fbb: FlatBuffer) -> Int32 {
        let memorySize = Int32(MemoryLayout<Int32>.size)
        let _off1 = off1 + fbb.read(def: Int32.self, position: Int(off1))
        let len1 = fbb.read(def: Int32.self, position: Int(_off1))
